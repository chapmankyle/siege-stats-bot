// file      : commands/season/ranked.js
...
module.exports = {
	name: 'ranked',
	description: 'Display current seasonal ranked information about a player.',
	execute(msg, args, ticket, sessionId) {
		// no player name given as argument
		if (args.length < 1) {
			msg.reply('you have not specified a player name. Try something like `!ss seasonal ranked Beaulo.TSM`');
			return;
		}
